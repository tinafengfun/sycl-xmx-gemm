// ==========================================================================
// BF16 GEMM v20f — Best configs full benchmark
// Only run the top-performing multi-SG configs with 100/500 iterations
// ==========================================================================
...
int main(int argc, char* argv[]) {
    ...
    printf("=== BF16 GEMM v20f — Best configs full benchmark ===\n");
    printf("Device: %s\n\n", q.get_device().get_info<sycl::info::device::name>().c_str());

    // === M=8192, N=2048, K=4096 ===
    printf("=== M=8192, N=2048, K=4096 ===\n");
    // Single SG baseline
    bench<4,4, 1,1>(q,8192,2048,4096,warmup,iters,"1SG_pf");
    bench<4,4, 1,1,true>(q,8192,2048,4096,warmup,iters,"1SG_nopf");
    // Best multi-SG: 4SG 2x2
    bench<4,4, 2,2>(q,8192,2048,4096,warmup,iters,"4SG_2x2_pf");
    bench<4,4, 2,2,true>(q,8192,2048,4096,warmup,iters,"4SG_2x2_nopf");
    // 8SG 4x2
    bench<4,4, 4,2>(q,8192,2048,4096,warmup,iters,"8SG_4x2_pf");
    bench<4,4, 4,2,true>(q,8192,2048,4096,warmup,iters,"8SG_4x2_nopf");

    // === M=8192, N=4096, K=4096 ===
    printf("\n=== M=8192, N=4096, K=4096 ===\n");
    bench<4,4, 1,1>(q,8192,4096,4096,warmup,iters,"1SG_pf");
    bench<4,4, 2,2>(q,8192,4096,4096,warmup,iters,"4SG_2x2_pf");
    bench<4,4, 4,2>(q,8192,4096,4096,warmup,iters,"8SG_4x2_pf");

    // === M=8192, N=8192, K=4096 ===
    printf("\n=== M=8192, N=8192, K=4096 ===\n");
    bench<4,4, 1,1>(q,8192,8192,4096,warmup,iters,"1SG_pf");
    bench<4,4, 2,2>(q,8192,8192,4096,warmup,iters,"4SG_2x2_pf");
    bench<4,4, 4,2>(q,8192,8192,4096,warmup,iters,"8SG_4x2_pf");

    // === Square large: M=N=K=4096 ===
    printf("\n=== M=N=K=4096 ===\n");
    bench<4,4, 1,1>(q,4096,4096,4096,warmup,iters,"1SG_pf");
    bench<4,4, 2,2>(q,4096,4096,4096,warmup,iters,"4SG_2x2_pf");
    bench<4,4, 4,2>(q,4096,4096,4096,warmup,iters,"8SG_4x2_pf");

    // === M=N=K=8192 ===
    printf("\n=== M=N=K=8192 ===\n");
    bench<4,4, 2,2>(q,8192,8192,8192,warmup,iters,"4SG_2x2_pf");
    bench<4,4, 4,2>(q,8192,8192,8192,warmup,iters,"8SG_4x2_pf");
