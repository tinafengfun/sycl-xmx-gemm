; ------------------------------------------------
; OCL_asm7b1f6d582d6091ee_beforeUnification.ll
; ------------------------------------------------
...
define spir_kernel void @_ZTSZZZ16bench_v3_if_onlyRN4sycl3_V15queueEiiiiiPKcENKUlvE_clEvENKUlRNS0_7handlerEE_clES7_EUlNS0_7nd_itemILi2EEEE_(i8 addrspace(1)* align 2 %0, i8 addrspace(1)* align 2 %1, i8 addrspace(1)* align 4 %2, i32 %3, i32 %4) #0 !kernel_arg_addr_space !280 !kernel_arg_access_qual !281 !kernel_arg_type !282 !kernel_arg_type_qual !283 !kernel_arg_base_type !282 !kernel_arg_name !283 !spirv.ParameterDecorations !284 !intel_reqd_sub_group_size !289 {
  %6 = alloca [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], align 8, !spirv.Decorations !290
  %7 = alloca i32, align 4, !spirv.Decorations !287
  %8 = alloca [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], align 8, !spirv.Decorations !290
  %9 = alloca [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], align 8, !spirv.Decorations !290
  %10 = alloca [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], align 8, !spirv.Decorations !290
  %11 = alloca [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], align 8, !spirv.Decorations !290
  %12 = addrspacecast i8 addrspace(1)* %0 to i8 addrspace(4)*
  %13 = addrspacecast i8 addrspace(1)* %1 to i8 addrspace(4)*
  %14 = addrspacecast i8 addrspace(1)* %2 to i8 addrspace(4)*
  %15 = call spir_func i32 @_Z25__spirv_BuiltInSubgroupIdv() #3
  %16 = sdiv i32 %15, 2
  %17 = mul i32 %16, 2
  %18 = sub i32 %15, %17
  %19 = call spir_func i64 @_Z26__spirv_BuiltInWorkgroupIdi(i32 1) #3
  %20 = icmp ult i64 %19, 2147483648
  call void @llvm.assume(i1 %20)
  %21 = trunc i64 %19 to i32
  %22 = call spir_func i64 @_Z26__spirv_BuiltInWorkgroupIdi(i32 0) #3
  %23 = icmp ult i64 %22, 2147483648
  call void @llvm.assume(i1 %23)
  %24 = trunc i64 %22 to i32
  %25 = shl nsw i32 %21, 6, !spirv.Decorations !292
  %26 = shl nsw i32 %16, 5, !spirv.Decorations !292
  %27 = add nsw i32 %25, %26, !spirv.Decorations !292
  %28 = shl nsw i32 %24, 7, !spirv.Decorations !292
  %29 = shl nsw i32 %18, 6, !spirv.Decorations !292
  %30 = add nsw i32 %28, %29, !spirv.Decorations !292
  %31 = call spir_func i8 addrspace(1)* @_Z41__spirv_GenericCastToPtrExplicit_ToGlobalPU3AS4ci(i8 addrspace(4)* %12, i32 5) #0
  %32 = call spir_func i8 addrspace(1)* @_Z41__spirv_GenericCastToPtrExplicit_ToGlobalPU3AS4ci(i8 addrspace(4)* %13, i32 5) #0
  %33 = call spir_func i8 addrspace(1)* @_Z41__spirv_GenericCastToPtrExplicit_ToGlobalPU3AS4ci(i8 addrspace(4)* %14, i32 5) #0
  %34 = bitcast [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 128, i8* %34)
  %35 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6, i64 0, i64 0, i64 0
  %36 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6, i64 1
  br label %37

37:                                               ; preds = %37, %5
  %38 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* [ %35, %5 ], [ %39, %37 ]
  %39 = getelementptr inbounds %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix", %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %38, i64 1
  %40 = bitcast [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %36 to %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"*
  %41 = ptrtoint %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %39 to i64
  %42 = ptrtoint %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %40 to i64
  %43 = icmp eq i64 %41, %42
  br i1 %43, label %.preheader1, label %37

.preheader1:                                      ; preds = %37
  br label %44

44:                                               ; preds = %65, %.preheader1
  %45 = phi i32 [ %66, %65 ], [ 0, %.preheader1 ]
...
49:                                               ; preds = %44
  %50 = addrspacecast i32* %7 to i32 addrspace(4)*
  %51 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %8, i64 0, i64 0
  %52 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %8, i64 1
  %53 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9, i64 0, i64 0
  %54 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9, i64 1
  %55 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %10, i64 0, i64 0
  %56 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %10, i64 1
  %57 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11, i64 0, i64 0
  %58 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11, i64 1
  %59 = sext i32 %3 to i64
  %60 = shl nsw i32 %4, 1, !spirv.Decorations !292
  %61 = sext i32 %60 to i64
  br label %73

62:                                               ; preds = %67, %47
  %63 = phi i32 [ %72, %67 ], [ 0, %47 ]
  %64 = icmp ult i32 %63, 4
  br i1 %64, label %67, label %65

65:                                               ; preds = %62
  %66 = add nuw nsw i32 %45, 1, !spirv.Decorations !294
  br label %44

67:                                               ; preds = %62
  %68 = zext i32 %63 to i64
  %69 = call spir_func %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* @_Z26__spirv_CompositeConstructf(float 0.000000e+00) #0
  %70 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6, i64 0, i64 %48, i64 %68
  %71 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %70 to %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* %69, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)** %71, align 8
  %72 = add nuw nsw i32 %63, 1, !spirv.Decorations !294
  br label %62

73:                                               ; preds = %184, %49
  %74 = phi i32 [ %82, %184 ], [ 0, %49 ]
  %75 = icmp slt i32 %74, %3
  br i1 %75, label %81, label %76

76:                                               ; preds = %73
  %77 = sext i32 %30 to i64
  %78 = bitcast i8 addrspace(1)* %33 to float addrspace(1)*
  %79 = getelementptr float, float addrspace(1)* %78, i64 %77
  %80 = sext i32 %4 to i64
  br label %211

81:                                               ; preds = %73
  %82 = add nuw nsw i32 %74, 32, !spirv.Decorations !294
...
84:                                               ; preds = %81
  ...
  store volatile i32 %82, i32 addrspace(4)* %50, align 4
  %86 = load volatile i32, i32 addrspace(4)* %50, align 4
...
97:                                               ; preds = %90
  %98 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9 to i8*
  call void @llvm.lifetime.start.p0i8(i64 32, i8* %98)
  br label %99

99:                                               ; preds = %99, %97
  %100 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"* [ %53, %97 ], [ %101, %99 ]
  ...
  %102 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %54 to %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"*
...
115:                                              ; preds = %108
  %116 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11 to i8*
  call void @llvm.lifetime.start.p0i8(i64 32, i8* %116)
  br label %117

117:                                              ; preds = %117, %115
  %118 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"* [ %57, %115 ], [ %119, %117 ]
  ...
  %120 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %58 to %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"*
...
131:                                              ; preds = %128
  ...
  %134 = mul nsw i64 %133, %61, !spirv.Decorations !292
  %135 = bitcast i8 addrspace(1)* %32 to %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)*
  ...
  %139 = mul nsw i64 %138, %61, !spirv.Decorations !292
  %140 = bitcast i8 addrspace(1)* %32 to %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)*
...
142:                                              ; preds = %128
  ...
  %144 = shl nuw nsw i32 %129, 3, !spirv.Decorations !294
  %145 = or i32 %27, %144
  %146 = mul nsw i32 %145, %3, !spirv.Decorations !292
  %147 = sext i32 %146 to i64
  %148 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %127, i64 %147
  %149 = call spir_func %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* @"_Z86__spirv_CooperativeMatrixLoadKHR_RPU3AS144__spirv_CooperativeMatrixKHR__short_3_8_16_0PU3AS138class.sycl::_V1::ext::oneapi::bfloat16ili"(%"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %148, i32 0, i64 %59, i32 0) #0
  %150 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %8, i64 0, i64 %143
  %151 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"* %150 to %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* %149, %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)** %151, align 8
  %152 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %148, i64 16
  %153 = call spir_func %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* @"_Z86__spirv_CooperativeMatrixLoadKHR_RPU3AS144__spirv_CooperativeMatrixKHR__short_3_8_16_0PU3AS138class.sycl::_V1::ext::oneapi::bfloat16ili"(%"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %152, i32 0, i64 %59, i32 0) #0
  %154 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9, i64 0, i64 %143
  %155 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"* %154 to %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* %153, %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)** %155, align 8
  %156 = add nuw nsw i32 %129, 1, !spirv.Decorations !294
  br label %128

157:                                              ; preds = %160, %131
  %158 = phi i32 [ %174, %160 ], [ 0, %131 ]
  %159 = icmp ult i32 %158, 4
  br i1 %159, label %160, label %.preheader

.preheader:                                       ; preds = %157
  br label %175

160:                                              ; preds = %157
  %161 = shl nuw nsw i32 %158, 4, !spirv.Decorations !294
  %162 = or i32 %30, %161
  %163 = zext i32 %158 to i64
  %164 = sext i32 %162 to i64
  %165 = shl nsw i64 %164, 1, !spirv.Decorations !292
  %166 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %136, i64 %165
  %167 = call spir_func %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* @"_Z87__spirv_CooperativeMatrixLoadKHR_RPU3AS145__spirv_CooperativeMatrixKHR__short_3_16_16_1PU3AS138class.sycl::_V1::ext::oneapi::bfloat16ili"(%"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %166, i32 2, i64 %61, i32 0) #0
  %168 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %10, i64 0, i64 %163
  %169 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"* %168 to %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* %167, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)** %169, align 8
  %170 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %141, i64 %165
  %171 = call spir_func %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* @"_Z87__spirv_CooperativeMatrixLoadKHR_RPU3AS145__spirv_CooperativeMatrixKHR__short_3_16_16_1PU3AS138class.sycl::_V1::ext::oneapi::bfloat16ili"(%"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %170, i32 2, i64 %61, i32 0) #0
  %172 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11, i64 0, i64 %163
  %173 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"* %172 to %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* %171, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)** %173, align 8
  %174 = add nuw nsw i32 %158, 1, !spirv.Decorations !294
  br label %157

175:                                              ; preds = %192, %.preheader
  %176 = phi i32 [ %193, %192 ], [ 0, %.preheader ]
  %177 = icmp ult i32 %176, 4
  br i1 %177, label %178, label %184

178:                                              ; preds = %175
  %179 = sext i32 %176 to i64
  %180 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %8, i64 0, i64 %179
  %181 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"* %180 to %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)**
  %182 = load %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)*, %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)** %181, align 8
  %183 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9, i64 0, i64 %179
  br label %189

184:                                              ; preds = %175
  %185 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11 to i8*
  call void @llvm.lifetime.end.p0i8(i64 32, i8* %185)
  %186 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %10 to i8*
  call void @llvm.lifetime.end.p0i8(i64 32, i8* %186)
  %187 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %9 to i8*
  call void @llvm.lifetime.end.p0i8(i64 32, i8* %187)
  %188 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"]* %8 to i8*
  call void @llvm.lifetime.end.p0i8(i64 32, i8* %188)
  br label %73

189:                                              ; preds = %194, %178
  %190 = phi i32 [ %210, %194 ], [ 0, %178 ]
  %191 = icmp ult i32 %190, 4
  br i1 %191, label %194, label %192

192:                                              ; preds = %189
  %193 = add nuw nsw i32 %176, 1, !spirv.Decorations !294
  br label %175

194:                                              ; preds = %189
  %195 = zext i32 %190 to i64
  %196 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %10, i64 0, i64 %195
  %197 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"* %196 to %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)**
  %198 = load %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)*, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)** %197, align 8
  %199 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6, i64 0, i64 %179, i64 %195
  %200 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %199 to %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)**
  %201 = load %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)*, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)** %200, align 8
  %202 = call spir_func %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* @_Z34__spirv_CooperativeMatrixMulAddKHRPU3AS144__spirv_CooperativeMatrixKHR__short_3_8_16_0PU3AS145__spirv_CooperativeMatrixKHR__short_3_16_16_1PU3AS144__spirv_CooperativeMatrixKHR__float_3_8_16_2i(%spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* %182, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* %198, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* %201, i32 64) #0
  %203 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1"* %183 to %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)**
  %204 = load %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)*, %spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)** %203, align 8
  %205 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"]* %11, i64 0, i64 %195
  %206 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2"* %205 to %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)**
  %207 = load %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)*, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)** %206, align 8
  %208 = call spir_func %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* @_Z34__spirv_CooperativeMatrixMulAddKHRPU3AS144__spirv_CooperativeMatrixKHR__short_3_8_16_0PU3AS145__spirv_CooperativeMatrixKHR__short_3_16_16_1PU3AS144__spirv_CooperativeMatrixKHR__float_3_8_16_2i(%spirv.CooperativeMatrixKHR._short_3_8_16_0 addrspace(1)* %204, %spirv.CooperativeMatrixKHR._short_3_16_16_1 addrspace(1)* %207, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* %202, i32 64) #0
  %209 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %199 to %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)**
  store %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* %208, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)** %209, align 8
  %210 = add nuw nsw i32 %190, 1, !spirv.Decorations !294
  br label %189

211:                                              ; preds = %224, %76
  %212 = phi i32 [ %225, %224 ], [ 0, %76 ]
  %213 = icmp ult i32 %212, 4
  br i1 %213, label %214, label %235

214:                                              ; preds = %211
  %215 = sext i32 %212 to i64
  %216 = shl nuw nsw i32 %212, 3, !spirv.Decorations !294
  %217 = or i32 %27, %216
  %218 = mul nsw i32 %217, %4, !spirv.Decorations !292
  %219 = sext i32 %218 to i64
  %220 = getelementptr float, float addrspace(1)* %79, i64 %219
  br label %221

221:                                              ; preds = %226, %214
  %222 = phi i32 [ %234, %226 ], [ 0, %214 ]
  %223 = icmp ult i32 %222, 4
  br i1 %223, label %226, label %224

224:                                              ; preds = %221
  %225 = add nuw nsw i32 %212, 1, !spirv.Decorations !294
  br label %211

226:                                              ; preds = %221
  %227 = zext i32 %222 to i64
  %228 = shl nuw nsw i32 %222, 4, !spirv.Decorations !294
  %229 = zext i32 %228 to i64
  %230 = getelementptr inbounds float, float addrspace(1)* %220, i64 %229
  %231 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6, i64 0, i64 %215, i64 %227
  %232 = bitcast %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"* %231 to %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)**
  %233 = load %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)*, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)** %232, align 8
  call spir_func void @_Z33__spirv_CooperativeMatrixStoreKHRPU3AS1fPU3AS144__spirv_CooperativeMatrixKHR__float_3_8_16_2ili(float addrspace(1)* %230, %spirv.CooperativeMatrixKHR._float_3_8_16_2 addrspace(1)* %233, i32 0, i64 %80, i32 0) #0
  %234 = add nuw nsw i32 %222, 1, !spirv.Decorations !294
  br label %221

235:                                              ; preds = %211
  %236 = bitcast [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix"]]* %6 to i8*
  call void @llvm.lifetime.end.p0i8(i64 128, i8* %236)
  ret void
}
