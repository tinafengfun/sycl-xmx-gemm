; ------------------------------------------------
; OCL_asmeace364ae9a9453a_afterUnification.ll
; ------------------------------------------------
...
100:                                              ; preds = %93
  %101 = add nuw nsw i32 %94, 32, !spirv.Decorations !415
  %102 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %18 to i8*
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %102)
  br label %103

103:                                              ; preds = %103, %100
  %104 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* [ %78, %100 ], [ %105, %103 ]
  %105 = getelementptr inbounds %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved", %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* %104, i64 1
  %106 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %18, i64 1, i64 0
  %107 = icmp eq %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* %105, %106
  br i1 %107, label %108, label %103

108:                                              ; preds = %103
  %109 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %19 to i8*
  call void @llvm.lifetime.start.p0i8(i64 64, i8* nonnull %109)
  br label %110

110:                                              ; preds = %110, %108
  %111 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* [ %79, %108 ], [ %112, %110 ]
  %112 = getelementptr inbounds %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved", %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* %111, i64 1
  %113 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %19, i64 1, i64 0
  %114 = icmp eq %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"* %112, %113
  br i1 %114, label %115, label %110

115:                                              ; preds = %110
  %116 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %20 to i8*
  call void @llvm.lifetime.start.p0i8(i64 128, i8* nonnull %116)
  br label %117

117:                                              ; preds = %117, %115
  %118 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* [ %80, %115 ], [ %119, %117 ]
  %119 = getelementptr inbounds %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved", %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* %118, i64 1
  %120 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %20, i64 1, i64 0
  %121 = icmp eq %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* %119, %120
  br i1 %121, label %122, label %117

122:                                              ; preds = %117
  %123 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %21 to i8*
  call void @llvm.lifetime.start.p0i8(i64 128, i8* nonnull %123)
  br label %124

124:                                              ; preds = %124, %122
  %125 = phi %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* [ %81, %122 ], [ %126, %124 ]
  %126 = getelementptr inbounds %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved", %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* %125, i64 1
  %127 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %21, i64 1, i64 0
  %128 = icmp eq %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"* %126, %127
  br i1 %128, label %129, label %124

129:                                              ; preds = %124
  %130 = zext i32 %94 to i64
  %131 = bitcast i8 addrspace(1)* %0 to %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)*
  %132 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %131, i64 %130
  br label %133

133:                                              ; preds = %147, %129
  %134 = phi i32 [ %175, %147 ], [ 0, %129 ]
  %135 = icmp ult i32 %134, 4
  br i1 %135, label %147, label %136

136:                                              ; preds = %133
  %137 = lshr exact i32 %94, 1
  %138 = zext i32 %137 to i64
  %139 = mul nsw i64 %138, %83, !spirv.Decorations !413
  ...
  %144 = mul nsw i64 %143, %83, !spirv.Decorations !413
  %145 = bitcast i8 addrspace(1)* %1 to %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)*
  %146 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %145, i64 %144
  br label %176

147:                                              ; preds = %133
  %148 = zext i32 %134 to i64
  %149 = shl nuw nsw i32 %134, 3, !spirv.Decorations !415
  %150 = or i32 %60, %149
  %151 = mul nsw i32 %150, %3, !spirv.Decorations !413
  %152 = sext i32 %151 to i64
  %153 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %132, i64 %152
  %154 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %153 to i8 addrspace(1)*
  %.ascast.i = addrspacecast i8 addrspace(1)* %154 to i8 addrspace(4)*
  %155 = ptrtoint i8 addrspace(4)* %.ascast.i to i64
  %156 = and i64 %155, -64
  ...
  %160 = shl i32 %3, 1
  %161 = add i32 %160, -1
  %162 = call <8 x i16> @llvm.genx.GenISA.LSC2DBlockRead.v8i16(i64 %156, i32 %161, i32 7, i32 %161, i32 %159, i32 0, i32 16, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0)
  %163 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %18, i64 0, i64 %148, i32 0
  store <8 x i16> %162, <8 x i16>* %163, align 8
  %164 = getelementptr %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %153, i64 16
  %165 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %164 to i8 addrspace(1)*
  %.ascast.i86 = addrspacecast i8 addrspace(1)* %165 to i8 addrspace(4)*
  %166 = ptrtoint i8 addrspace(4)* %.ascast.i86 to i64
  %167 = and i64 %166, -64
  ...
  %171 = shl i32 %3, 1
  %172 = add i32 %171, -1
  %173 = call <8 x i16> @llvm.genx.GenISA.LSC2DBlockRead.v8i16(i64 %167, i32 %172, i32 7, i32 %172, i32 %170, i32 0, i32 16, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0)
  %174 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %19, i64 0, i64 %148, i32 0
  store <8 x i16> %173, <8 x i16>* %174, align 8
  %175 = add nuw nsw i32 %134, 1, !spirv.Decorations !415
  br label %133

176:                                              ; preds = %179, %136
  %177 = phi i32 [ %207, %179 ], [ 0, %136 ]
...
179:                                              ; preds = %176
  ...
  %181 = shl i32 %177, 5
  %182 = shl nuw i32 %64, 1
  %183 = or i32 %181, %182
  %184 = zext i32 %183 to i64
  %185 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %141, i64 %184
  %186 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %185 to i8 addrspace(1)*
  ...
  %192 = shl i32 %4, 2
  %193 = add i32 %192, -1
  %194 = call <8 x i32> @llvm.genx.GenISA.LSC2DBlockRead.v8i32(i64 %188, i32 %193, i32 7, i32 %193, i32 %191, i32 0, i32 32, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0)
  %195 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %20, i64 0, i64 %180, i32 0
  store <8 x i32> %194, <8 x i32>* %195, align 8
  %196 = getelementptr inbounds %"class.sycl::_V1::ext::oneapi::bfloat16", %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %146, i64 %184
  %197 = bitcast %"class.sycl::_V1::ext::oneapi::bfloat16" addrspace(1)* %196 to i8 addrspace(1)*
  %.ascast.i88 = addrspacecast i8 addrspace(1)* %197 to i8 addrspace(4)*
  %198 = ptrtoint i8 addrspace(4)* %.ascast.i88 to i64
  %199 = and i64 %198, -64
  ...
  %203 = shl i32 %4, 2
  %204 = add i32 %203, -1
  %205 = call <8 x i32> @llvm.genx.GenISA.LSC2DBlockRead.v8i32(i64 %199, i32 %204, i32 7, i32 %204, i32 %202, i32 0, i32 32, i32 16, i32 8, i32 1, i1 false, i1 false, i32 0)
  %206 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %21, i64 0, i64 %180, i32 0
  store <8 x i32> %205, <8 x i32>* %206, align 8
  %207 = add nuw nsw i32 %177, 1, !spirv.Decorations !415
  br label %176

208:                                              ; preds = %223, %.preheader
  %209 = phi i32 [ %224, %223 ], [ 0, %.preheader ]
  %210 = icmp ult i32 %209, 4
  br i1 %210, label %211, label %215

211:                                              ; preds = %208
  %212 = zext i32 %209 to i64
  %213 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %18, i64 0, i64 %212, i32 0
  %214 = load <8 x i16>, <8 x i16>* %213, align 8
  br label %220

215:                                              ; preds = %208
  %216 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %21 to i8*
  call void @llvm.lifetime.end.p0i8(i64 128, i8* nonnull %216)
  %217 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.2.resolved"]* %20 to i8*
  call void @llvm.lifetime.end.p0i8(i64 128, i8* nonnull %217)
  %218 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %19 to i8*
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %218)
  %219 = bitcast [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %18 to i8*
  call void @llvm.lifetime.end.p0i8(i64 64, i8* nonnull %219)
  br label %93

220:                                              ; preds = %225, %211
  %221 = phi i32 [ %239, %225 ], [ 0, %211 ]
  %222 = icmp ult i32 %221, 4
  br i1 %222, label %225, label %223

223:                                              ; preds = %220
  %224 = add nuw nsw i32 %209, 1, !spirv.Decorations !415
  br label %208
...
225:                                              ; preds = %220
  ...
  %229 = getelementptr inbounds [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.resolved"]], [4 x [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.resolved"]]* %17, i64 0, i64 %212, i64 %226
  ...
  %232 = call <8 x float> @llvm.genx.GenISA.sub.group.dpas.v8f32.v8f32.v8i16.v8i32(<8 x float> %231, <8 x i16> %214, <8 x i32> %228, i32 11, i32 11, i32 8, i32 8, i1 false)
  %233 = getelementptr inbounds [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"], [4 x %"struct.sycl::_V1::ext::oneapi::experimental::matrix::joint_matrix.1.resolved"]* %19, i64 0, i64 %212, i32 0
...
250:                                              ; preds = %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_SG16_8x16_i32_8_global_pi64_v8i8.252.exit, %243
  %251 = phi i32 [ %288, %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_SG16_8x16_i32_8_global_pi64_v8i8.252.exit ], [ 0, %243 ]
...
268:                                              ; preds = %255
  ...
  br i1 %279, label %280, label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_SG16_8x16_i32_8_global_pi64_v8i8.252.exit

280:                                              ; preds = %268, %255
  br label %__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_SG16_8x16_i32_8_global_pi64_v8i8.252.exit

__builtin_spriv_OpJointMatrixStoreINTEL_Accumulator_RowMajor_SG16_8x16_i32_8_global_pi64_v8i8.252.exit: ; preds = %268, %280
